<h1 align="center">
  <img src="https://i.slow.pics/T7o2WYO7.png" alt="win11" width="28" height="28" /> Fluent Design App List  <img src="https://i.slow.pics/T7o2WYO7.png" alt="win11" width="28" height="28">
</h1>
...
- ### 📝 Notes
  - `FDM` [Typedown](https://apps.microsoft.com/store/detail/typedown/9P8TCW4H2HB4) <sup>`FOSS`</sup> <sup>`⭐`</sup>
...
- `FDM` [S Files Pro X - Shrestha File Explorer](https://apps.microsoft.com/detail/9NPNFFSV2HQM) <sup>`💰`</sup>
...
- `FDM` [Zen Browser](https://github.com/zen-browser/desktop) <sup>`FOSS`</sup> <sup>`📎Uses its own implementation of Mica effect`</sup>
...
- ### 🧰 Developer Tools
  ...
  - `FDM` [DevToys](https://github.com/veler/DevToys) <sup>`FOSS`</sup> <sup>`⭐`</sup>
...
- ### 🛍️ App Stores
   ...
   - `FDM` [UniGetUI](https://github.com/marticliment/UniGetUI) <sup>`FOSS`</sup>
...
- ### 🛠️ Other Utilities
  ...
  - `FDM` [CtrlHelp](https://ctrlhelp.velersoftware.com/)
